...
kruskal.test(data = Ref_DE, AvPRF ~ group)
```
...
kruskal.test(data = Ref_DK, AvPRF ~ group)
```
...
```{r cor DE, echo=FALSE}
par(mfrow = c(2,2))
plot(Ref_DE$AvPRF,Ref_DE$medianKHz)
cor(Ref_DE$AvPRF,Ref_DE$medianKHz, method = "spearman")

plot(Ref_DE$AvPRF,Ref_DE$NofClstrs)
cor(Ref_DE$AvPRF,Ref_DE$NofClstrs, method = "spearman")

plot(Ref_DE$AvPRF, Ref_DE$nActualClx)
cor(Ref_DE$AvPRF, Ref_DE$nActualClx, method = "spearman")

plot(Ref_DE$AvPRF,Ref_DE$MinICI_us)
cor(Ref_DE$AvPRF,Ref_DE$MinICI_us, method = "spearman")
```

```{r cor DK, echo=FALSE}
par(mfrow = c(2,2))
plot(Ref_DK$AvPRF,Ref_DK$medianKHz)
cor(Ref_DK$AvPRF,Ref_DK$medianKHz, method = "spearman")

plot(Ref_DK$AvPRF,Ref_DK$NofClstrs)
cor(Ref_DK$AvPRF,Ref_DK$NofClstrs, method = "spearman")

plot(Ref_DK$AvPRF, Ref_DK$nActualClx)
cor(Ref_DK$AvPRF, Ref_DK$nActualClx, method = "spearman")

plot(Ref_DK$AvPRF,Ref_DK$MinICI_us)
cor(Ref_DK$AvPRF,Ref_DK$MinICI_us, method = "spearman")
```

```{r cor DE/DK, echo=FALSE}
par(mfrow = c(2,2))
plot(Ref_both$AvPRF,Ref_both$medianKHz)
cor(Ref_both$AvPRF,Ref_both$medianKHz, method = "spearman")

plot(Ref_both$AvPRF,Ref_both$NofClstrs)
cor(Ref_both$AvPRF,Ref_both$NofClstrs, method = "spearman")

plot(Ref_both$AvPRF, Ref_both$nActualClx)
cor(Ref_both$AvPRF, Ref_both$nActualClx, method = "spearman")

plot(Ref_both$AvPRF,Ref_both$MinICI_us)
cor(Ref_both$AvPRF,Ref_both$MinICI_us, method = "spearman")
```