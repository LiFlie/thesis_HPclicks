---
title: "HPclicks average frequency of last cycle"
author: "Lina Fliess"
date: "`r Sys.Date()`"
...
```{r summarys DE}
summary(Ref_DE_Aschau$avEndF)
summary(Ref_DE_BoEck$avEndF)
summary(Ref_DE_Langholz$avEndF)
```

###Visualization/Plots:

```{r histogram DE, echo=FALSE}
ggplot(Ref_DE, aes(x = avEndF, fill = group)) +
  geom_histogram(bins = 50, alpha = 0.5, position = "identity") +
  labs(title = "Average of End Frequency Distribution", x = "Average End Frequency", y = "Count") +
...
ggplot(Ref_DE, aes(x = group, y = avEndF, fill = group)) +
  geom_boxplot() +
  labs(title = "Boxplot of Average End Frequency", x = "Group", y = "Average End Frequency") +
  theme_minimal()
```

```{r scatter plot DE, echo=FALSE}
ggplot(Ref_DE, aes(x = group, y = avEndF, color = group)) +
  geom_jitter(width = 0.2, alpha = 0.5) +
  labs(title = "Scatter Plot of Mean Frequency", x = "Group", y = "Average End Frequency") +
  theme_minimal()
```
...
kruskal.test(data = Ref_DE, avEndF ~ group)
```
...
```{r summarys DK}
summary(Ref_DK_6621$avEndF)
summary(Ref_DK_6623$avEndF)
summary(Ref_DK_6625$avEndF)
```

###Visualization/Plots:

```{r histogram DK, echo=FALSE}
ggplot(Ref_DK, aes(x = avEndF, fill = group)) +
  geom_histogram(bins = 50, alpha = 0.5, position = "identity") +
  labs(title = "Average of End Frequency Distribution", x = "Average End Frequency", y = "Count") +
  scale_fill_manual(name = "Dataset", 
                    values = c('6621' = 'gold', 
...
ggplot(Ref_DK, aes(x = avEndF, fill = group)) +
  geom_density(bins = 50, alpha = 0.5, position = "identity") +
  labs(title = "Average of End Frequency Distribution", x = "Avergae End Frequency", y = "Count") +
  scale_fill_manual(name = "Dataset", 
                    values = c('6621' = 'gold', 
                               '6623' = 'orange', 
                               '6625' = 'red')) +
...
ggplot(Ref_DK, aes(x = group, y = avEndF, fill = group)) +
  geom_boxplot() +
  labs(title = "Boxplot of Average End Frequency", x = "Group", y = "Avergae End Frequency") +
  theme_minimal()
```

```{r scatter plot DK, echo=FALSE}
ggplot(Ref_DK, aes(x = group, y = avEndF, color = group)) +
  geom_jitter(width = 0.2, alpha = 0.5) +
  labs(title = "Scatter Plot of Average End Frequency", x = "Group", y = "Average End Frequency") +
  theme_minimal()
```
...
kruskal.test(data = Ref_DK, avEndF ~ group)
```
...
kruskal_result <- kruskal.test(data = Ref_both, avEndF ~ group)
```
