...
Aim: determine whether harbour porpoise show significant differences in their echolocation behaviour around nets between germany and denmark
...
harbour porpoise (Phocoena phocoena) s a marine mammal in the Phocoenidae family, members of the toothed whale family
...
The used Data was obtained in Germany and Denmark. Three reference points of Observation in each country with three obersavtion periods
Map of area with postioned FPODS: 

Eight fishers selected to use PAL.

\subsection{PAM/Acoustic Monitoring}
...
Use of software R, packages, statistical tests, hypothesis, significance of parameters: Wilcoxon-Mann-Whitney/Kruskal-Wallis (more than two datasets), effect-size calculation: eta-squared 
