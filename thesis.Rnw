...
%Objective maybe at end of introduction?
...
- summary with data ??
- PLOTS
* 4 histograms or density plot, one for each parameter, comparing germany and denmark in each plot (and the reference stations itself?)
