...
webshot("map.html", file = "map.png", vwidth = 400, vheight = 200)
@
%add the just construcet map.png into th document
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{map.png}
\caption{Position of the FPODS}
\end{figure}
...
Use of software R, packages, statistical tests, hypothesis, significance of parameters: Wilcoxon -Mann -Whitney /Kruskal-Wallis (more than two datasets),
